...
def build_workbook(cash, slip):
    ...
    for br in BRANCHES:
        ...
        # Blue row highlight for cashiers who are paying out (PaidOut > 0).
        BLUE_NAME = PatternFill("solid", fgColor="5B9BD5")    # darker blue for the row
        ...
        for _, row_ in sub.iterrows():
            ...
            # Name + Total Bets highlight priority:
            #   paying out (PaidOut > 0) -> BLUE row highlight on name + total bets
            #   otherwise 5000+ -> green ; below 5000 -> red
            if paid_out > 0:
                name_fill = BLUE_NAME
            else:
